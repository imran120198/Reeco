...
import BottomOrderStyle from "../Style/BottomOrderDetail.styled";

const { OrderDetailsContainer, Item, ItemHeader, ItemDetails, Separator } =
  BottomOrderStyle;

const BottomOrderDetail = () => {
  ...
  return (
    <OrderDetailsContainer>
      ...
      <Item>
        ...
        {/* <div>
          <img src={} style={{ height: "50px", width: "200px" }} />
        </div> */}
      </Item>
      <Separator></Separator>
      <Item>
...
export default BottomOrderDetail;
